...
$(document).ready(function() {
	...
	$('#logout a').click(function(e) {
		...
		$.SmartMessageBox({
			...
			content: "Voc&ecirc; pode melhorar sua seguran&ccedil;a ainda mais, depois de sair feche este navegador",
			buttons: '[N&atilde;o][Sim]'
...
function loadURL(url, container) {
	...
	$.ajax({
		...
		beforeSend : function() {
			// cog placed
			container.html('<h1><i class="fa fa-cog fa-spin"></i> Carregando...</h1>');
