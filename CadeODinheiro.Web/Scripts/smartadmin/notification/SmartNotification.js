...
(function ($) {
    $.SmartMessageBox = function (settings, callback) {
        ...
        if (isIE8orlower() == 0) {
            ...
            audioElement.setAttribute('src', 'Content/sound/messagebox.mp3');
            $.get();
        ...
        if (settings.sound === true) {
            if (isIE8orlower() == 0) {
                ...
                if (navigator.userAgent.match('Firefox/'))
                    audioElement.setAttribute('src', 'Content/sound/bigbox.ogg');
                else
                    audioElement.setAttribute('src', 'Content/sound/bigbox.mp3');
    ...
    $.smallBox = function (settings, callback) {
        ...
        if (settings.sound === true) {
            if (isIE8orlower() == 0) {
                ...
                if (navigator.userAgent.match('Firefox/'))
                    audioElement.setAttribute('src', 'Content/sound/smallbox.ogg');
                else
                    audioElement.setAttribute('src', 'Content/sound/smallbox.mp3');
